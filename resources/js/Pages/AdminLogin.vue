<template>
    <div class="login-container">
        ...
        <!-- <div class="vendor-link">
            <router-link to="/admin/vendor-login">Login as vendor</router-link>
        </div> -->
        ...
        <div class="login-box">
            ...
            <div class="register-link">
                ...
                <router-link to="/admin/admin-register">Register</router-link>
            </div>
        </div>
    </div>
</template>
...
let loginAdmin = async () => {
    ...
    let response = await axios.post('/login-admin', form.value);
