    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <form @submit.prevent="login">
                ...
                <!-- <button type="submit" @click.prevent="registerAdmin">Register</button> -->
            ...
            <div class="register-link">
                ...
                <router-link to="/admin/admin-login">Login</router-link>
            </div>
        </div>
    </div>
</template>
...
let registerAdmin = async () => {
    ...
    let response = await axios.post('/register-admin', form.value);
